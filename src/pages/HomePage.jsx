  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[80px]">
      ...
      <section className="py-16 md:py-[120px] flex flex-col items-center text-center">
        <span className="text-style-label-sm text-vermilion tracking-widest mb-4" data-aos="fade-down">
          {brand.eyebrow}
        </span>
        <MaskedHeading className="text-style-headline-lg text-ink mb-6 max-w-3xl" delay={0.1}>
          {brand.headline}
        </MaskedHeading>
        <p className="text-style-body-lg text-tea-brown max-w-2xl mb-8" data-aos="fade-up" data-aos-delay="160">
          {brand.description}
          <br />
          <br />
      ...
      <section className="py-16 md:py-[120px] border-t border-ink/10 text-center">
        ...
        <p
          className="text-style-body-md text-tea-brown mt-8 max-w-2xl mx-auto text-left md:text-center"
          data-aos="fade-up"
        >
